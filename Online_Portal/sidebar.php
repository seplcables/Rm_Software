                ...
                <ul class="list-unstyled components">
                    ...
                    <li class="">
                        ...
                        <ul class="collapse list-unstyled" id="purchase">
                            ...
                            <li>
                               <a href="PO\report_696.php"><span>5.1</span> Purchase-696</a>
                            </li>
                            <li>
                               <a href="PO\psummary\psummary.php"><span>6.0</span> Purchase Summary </a>
                            </li>
                            <li>
                               <a href="PO\reportItemWise.php"><span>7.0</span> Item History </a>
                            </li>
                            <li>
                               <a href="PO\tcreceipt_report.php"><span>7.1</span> TC Receipt </a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="#696_plant" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <i class="fa fa-download"></i>
                            696_plant
                        </a>
                        <ul class="collapse list-unstyled" id="696_plant">
                            
                            <li>
                                <a href="PO\Requisition-696\showRequisition.php"><span>1.0</span> Requisition</a>
                            </li>
                            <li>
                                <a href="PO\adddata-696.php"><span>2.1</span> PO entry</a>
                            </li>
                            <li>
                                <a href="PO\showdata-696.php"><span>2.2</span> Search PO</a>
                            </li>
                            <li>
                                <a href="PO\inward_field-696.php"><span>3.1</span> Purchase entry</a>
                            </li>
                            <li>
                               <a href="PO\showinvoice-696.php"><span>3.2</span> Search Purchase</a>
                            </li>
                            <li>
                               <a href="PO\po_to_inward-696.php"><span>4.0</span> Pending PO </a>
                            </li>
                            <li>
                               <a href="PO\purchase-report-696.php"><span>5.0</span> Purchase Report</a>                               
                            </li>
                            <li>
                                <a href="PO\store\report-696.php"><span>6.0</span> Live Stock</a>
                            </li>
                            <li>
                                <a href="PO\store\issue_rep-696.php"><span>7.0</span> Issue Report</a>
                            </li>
                    ...
                    <li class="">
                        ...
                        <ul class="collapse list-unstyled" id="payment">
                            ...
                            <li>
                                <a href="PO\payment_sys\advancePayment.php"><span>5.</span> Advance Payment</a>
                            </li>
                            <li>
                               <a href="PO\payment_sys\pymt_report.php"><span>6.</span> Payment Report</a>
                            </li>
                            <li>
                               <a href="PO\payment_sys\pymt_verify.php"><span>7.</span> Payment Verify</a>
                            </li>
                            <li>
                               <a href="PO\payment_sys\account_head.php"><span>8.</span> Account Head</a>
                            </li>
                            <li>
                               <a href="PO\payment_sys\ac_head_report.php" target="_blank"><span>9.</span> Account Head Report</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                        ...
                        <ul class="collapse list-unstyled" id="store">
                            ...
                            <li>
                                <a href="PO\store\bill_out.php"><span>10.</span> Bill_Out</a>
                            </li>
                            <li>
                                <a href="PO\store\shoes_issue.php"><span>11.</span> Shoes Issue</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="">
                        ...
                        <ul class="collapse list-unstyled" id="RM">
                            ...
                            <li>
                                <a href="PO\RM\pvcIssueBc.php">Barcode Issue</a>
                            </li>
                            <li>
                                <a href="PO\RM\pvcBarCodeReoprt.php">Barcode Reoprt</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="PO\RM\stock_mismatch-new.php">Stock mismatch</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="PO\RM\subGradeReport.php">Grade Wise Report</a>
                            </li>
                            <li>
                                <a href="PO\RM\rmtaWiseReport.php">RMTA Wise Report</a>
                            </li>
                        </ul>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        <a href="#VendorSub" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <i class="fa fa-industry"></i>
                            Vendor Rating
                        </a>
                        <ul class="collapse list-unstyled" id="VendorSub">
                            <li>
                                <a href="PO\vendor\vendorIS.php">IS</a>
                            </li>
                            <li>
                                <a href="PO\vendor\venderCal.php">Calculation</a>
                            </li>
                            <li>
                                <a href="PO\vendor\supplyRatingReport.php">Supply Rating Report</a>
                            </li>
                    ...
                    <!-- <li class="">
                        ...
                        <ul class="collapse list-unstyled" id="master">
                            ...
                            <li>
                                <a href="PO\add_master\make_by_master.php">Make_by</a>
                            </li>
                            <li>
                                <a href="PO\add_master\modelno_master.php">Model_no</a>
                            </li>
                            <li>
