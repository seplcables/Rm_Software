...
// Logo
					      ...
					      include('..\..\..\dbcon.php');	
						  $sid = $_GET['sid'];
						  $sql1="SELECT a.aprvBy,a.iid,a.item_code,b.item,d.category,a.qnty,a.rate,a.qnty*a.rate as basic,a.mc,a.department,a.type,a.old_part_status,c.indentor,c.mat_require_dte,c.remarks,c.createdAt from Requisition_details a
