...
<body>
	<div class="container-fluid mt-2">
		<form action="adddata_to_db.php" method="POST" id="setform">
        ...
        ?>
								...
								<div class="table-responsive">
									<table class="table-bordered table">
										<tr style="background-color: slategrey; color: white;">
											...
											<th class="col-form-label-sm  font" style="width: 25%;">JOB</th>
											<th class="col-form-label-sm  font" style="width: 40%;">REMARK</th>
										</tr>
										<tr>
								...
								<div class="table-responsive">
									<table class="table-bordered table">
										<tr style="background-color: slategrey; color: white;">
											...
											<th class="col-form-label-sm  font" style="width: 30%;">Sub Project</th>
										</tr>
										<tr>
											<td class="d-flex">
											...
											<td><input type="text" class="form-control form-control-sm font" style="height: 10px;" name="sub_project" id="sub_project">
												</td>
										</tr>
									</table>
								</div>
							...
							<div class="table-responsive">
								<table class="table-bordered table">
									...
									<tr>
										...
										<td><input type="text" class="form-control form-control-sm font" name="" id="plant"></td>
										<td>
							...
							<?php
                              if (isset($_SESSION['pono_entry'])) {
                                  ?>
						      <a href="pdfdata.php?sid=<?php echo $_SESSION['pono_entry']; ?>" class="btn btn-warning btn-sm float-end px-5 py-1" id="print" style="font-size:17px;">Print</a>
						      <?php
                              } ?>
								</div>
							</div>
 ...
 /* $("#data_head").show();*/
  ...
  html += '<tr>';
    ...
    html += '<td><input type="text" class="form-control text-center" name="project[]" id="'+count+'project" readonly style="width:150px"></td>';
     html += '<td><input type="text" class="form-control text-center" name="sub_project[]" id="'+count+'sub_project" readonly style="width:150px"></td>';
   ...
   html += '</tr>';
    ...
    $('#'+count+'sub_project').val(sub_project);
    $('#sub_project').val('');
    var job = $('#job').val();
    $('#'+count+'job').val(job);
    $('#job').val('');
