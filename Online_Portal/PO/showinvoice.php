...
<html lang="en">
    ...
    optionLink = "<a class=\"btn btn-sm btn-primary\" href=\"purchase_entry_edit.php?srno=" + data.sr_no + "&plant=" + data.receive_at + "\">Edit</a> " ;
...
$(document).ready(function() {
    var table = $('#example').DataTable( {
        ...
        "columns": [
            ...
            type: "date",
            render: function (data, type, row) { return data ? moment(data).format('DD-MMM-YY hh:mm:ss') : ''; }
            },
            {   "mData": null,
                    "bSortable": false,
