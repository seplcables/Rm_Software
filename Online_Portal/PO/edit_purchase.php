...
session_start();
 ...
 {  
 	...
 	$sql = "SELECT * from inward_ind where iid='$item_id' AND sr_no='$rmta'";
...
$total_amt = $row["total_amt"];
    ...
    $result = array("$item_desc", "$hsn_code", "$project", "$job", "$remark", "$stock", "$main_grade", "$sub_grade", "$pkg", "$qnty", "$rate", "$unit", "$plant", "$disc_per", "$disc_amt", "$packaging", "$insurance", "$freight", "$other_charge", "$taxable_amt", "$cgst_per", "$cgst_amt", "$sgst_per", "$sgst_amt", "$igst_per", "$igst_amt", "$tcs_per", "$tcs_amt", "$total_tax_amt", "$total_amt", "$i_code", "$s_code", "$m_code");
