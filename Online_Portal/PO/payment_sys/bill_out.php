<?php
session_start();
if ($_SESSION['oid'] =='snehal' || $_SESSION['oid'] =='Rajnish' || $_SESSION['oid'] =='manish'|| $_SESSION['oid'] =='mitra'|| $_SESSION['oid'] =='Pratik' || $_SESSION['oid'] =='Rashmik')
{
?>
<!DOCTYPE html>
<html lang="en">
...
<br>
		...
		<div class="table-responsive m-1">
			<table class="table table-bordered table-striped table-sm" id="employee_data">
				...
				$sql="SELECT * from inward_com where receive_date >= '2021-02-01' AND bill_send ! = 1 ORDER BY receive_date desc";
    ...
    'pageLength', 'excel',
           {
             ...
             },
             {
                ...
                action: function () { 
                  window.open('JW/bill_out.php','_self');  
               }
             },
             {
