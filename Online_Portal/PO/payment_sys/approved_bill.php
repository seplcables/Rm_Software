...
<html lang="en">
	...
	<body>
		<h3 class="bg-primary text-white" align="center">APPROVED BILL</h3><br/>
		...
		<div class="table-responsive m-1">
			...
			<table class="table table-bordered table-striped" id="employee_data">
				...
				<?php
				include('..\..\..\dbcon.php');
				$sql="SELECT * from inward_com where bill_send = 1 AND bill_receive= 1 AND bill_approve = 1 AND receive_date > '2022-01-01' ORDER BY approve_time desc";
				...
				<tr class="text-center font-italic" id="<?php echo $row["sr_no"].$row['receive_at']; ?>">
					<td><?php echo $row['approve_time']->format('d-M-Y');  ?></td>
