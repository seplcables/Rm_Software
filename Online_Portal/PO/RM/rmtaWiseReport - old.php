  ...
  <body>
    ...
    <div class="table-responsive" style="padding:1%;">
      <table class="table table-bordered table-striped table-sm" id="employee_data">
        ...
        <?php
              $i=0;
              $sql="SELECT a.p_item, a.sr_no, sum(a.rec_qnty) as recqty from inward_ind a , inward_com b 
where a.sr_no = b.sr_no and b.receive_date >= '2022-12-30'  group by a.p_item, a.sr_no order by sr_no DESC
";
              ...
              while ($row = sqlsrv_fetch_array($run, SQLSRV_FETCH_ASSOC)) 
              {
                ...
                $val = array();
                $val1 = array();
                $sql1="SELECT grade_code, rmta, sum(issue_qnty) as issueqty from pvc_issue where issue_date >= '2022-12-30' and  PARSENAME(REPLACE(rmta,'/','.'),2) = '".$row['sr_no']."' and grade_code = '".$row["p_item"]."'  group by grade_code,rmta order by rmta DESC";
