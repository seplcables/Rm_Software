    ...
    <div class="container-fluid mt-2">
        ...
        <div class="p-4">
               <table class="table table-bordered dataTable no-footer" id="myTable">
                  ...
                  <tbody>
                    <?php
                    $fromdt = date("Y-m-d", strtotime("-10 day"));
                    $todate = date('Y-m-d');
                    ...
                    $sql = "SELECT DISTINCT b.sr_no, b.receive_at,  a.issue_date, a.barcode_no, a.mc, a.issue_qnty , c.item, e.party_name  FROM 
                            ...
                            join inward_com d on d.sr_no = b.sr_no  and d.receive_at = b.receive_at  join rm_party_master e on d.mat_from_party = e.pid where a.issue_date between '".$fromdt."' and '".$todate."' order by a.issue_date desc";
    ...
    $(document).ready( function ()
    {
        $('#myTable').DataTable(
        {
            ...
            buttons: [
                ...
                action: function () { 
                     window.open("pvcBarCodeReportAll.php","_self");
                 }
               },
            ],
        });
