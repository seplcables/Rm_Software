...
<?php if(isset($_SESSION['noReturn'])): ?>
  alert('इसे RETURN नहीं किया जा सकता है');
<?php endif; ?>
<?php unset($_SESSION['noReturn']); ?>
...
<html>
	...
	<body class="container">
		<div class="box mt-2">
			...
			<!-- Alert message -->
			<h3>PVC RETURN  <button type="button" class="btn btn-outline-dark text-dark font-weight-bold float-right" id="issue">ISSUE</button></h3>
			<form action="rmReturnBC_db.php" method="POST" id="setform">
				<div class="mt-3">
				...
				<button type="submit" name="update" class="btn font-weight-bold" id="submit">Save</button>
...
window.open('rmIssueBC.php','_self');
