...
include('..\..\dbcon.php');
    ...
    $sql = "SELECT distinct a.id,a.po_date,a.po_gen_by,b.party_name,a.depart_ment,a.isPurchaseEntry,a.po_value from po_entry_head a
             LEFT OUTER JOIN rm_party_master b on a.party = b.pid left outer join po_entry_details c on c.iid = a.id  where p_terms != 'cancle' AND c.plant ='696'  order by id desc";
    ...
    <tbody id="t_bdy1">
        ...
        $output .= '
        	...
        	<td>'.$row['po_value'].'</td>
        	<td><a class="btn btn-sm btn-danger" href="pdfdata-696.php?sid='.$row['id'].'">pdf</a> </td>
        	</tr>
               ';
         }      
    echo $output;
