...
<html lang="en">
  ...
  <body class="">
    <div class="bg-dark text-center text-white">
      ...
      <form action="adddata_to_db.php" method="post" id="jw_challan">
        <div class="form-row">
          <div class="form-group col-6">
            <label for="date" class="font-weight-bold font-italic">Date :-</label>
            <input type="text" class="form-control" value="<?php echo date("d-M-y", time()); ?>" name="date" id="date" required>
          </div>
          <div class="form-group col-2"></div>
          <div class="form-group col-4">
            <label for="sr_no" class="font-weight-bold font-italic">Sr_No :-</label>
            <input type="text" class="form-control" value="<?php echo $sr_no; ?>" id="sr_no" name="sr_no" readonly>
          </div>
        </div>
        <!-- grouping pannel -->
        ...
        <div class="form-row  mt-3">
          <div class="form-group col-md-8">
            ...
            <input type="text" value="Suyog Electricals Limited" class="form-control font-italic" name="name" id="name" readonly>
          </div>
      ...
      <div class="form-row  mt-3">
        <div class="form-group col-md-8">
          ...
          <input type="text" value="" class="form-control font-italic" tabindex="1" name="name1" id="name1" onFocus="SearchParty(this)" required>
          <input type="hidden" value="" class="form-control font-italic" name="pid" id="pid">
        </div>
        <div class="form-group col-md-4">
          <label for="gst1" class="">GST No :-</label>
          <input type="text" value="" class="form-control font-italic font-weight-bold" name="gst1" id="gst1" readonly>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-12">
          <label for="add1" class="">Address :-</label>
          <input type="text" value="" class="form-control" name="add1" id="add1" readonly>
        </div>
    ...
    <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="dog" id="dog" tabindex="2" onFocus="SearchGoods(this)" required>
          </div>
          <div class="form-group col-md-6">
            <label for="identify" class="font-weight-bold font-italic">Identification marks & number, if any :-</label>
            <input type="text" class="form-control" value="N/a" id="identify" tabindex="3" name="identify">
          </div>
        </div>
      <div class="form-row">
          <div class="form-group col-8">
            <label for="qnty" class="font-weight-bold font-italic">Quantity :-</label>
            <input type="number" step="0.01" class="form-control" tabindex="4" name="qnty" id="qnty" autocomplete="off" required>
          </div>
          <div class="form-group col-4">
      ...
      <div class="form-row">
          <div class="form-group col-8">
            ...
            <input type="text" class="form-control" name="val" autocomplete="off" tabindex="6" id="val" required>
          </div>
          <div class="form-group col-4">
      ...
      <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="taxable_goods" id="taxable_goods" readonly>
          </div>
          <div class="form-group col-md-6">
            <label for="vehicle_no" class="font-weight-bold font-italic">Mode of Transport Vehicle No.  :-</label>
            <input type="text" class="form-control" id="vehicle_no" tabindex="7" name="vehicle_no" placeholder="XX-00-XX-0000">
          </div>
      </div>
      <div class="form-row">
          <div class="form-group col-md-6">
            <label for="nature_of processing" class="font-weight-bold font-italic">Nature of Processing Required to be done :-</label>
            <input type="text" class="form-control" name="nature_of_processing" id="nature_of_processing" readonly>
          </div>
          <div class="form-group col-md-6">
            <label for="duration_days" class="font-weight-bold font-italic">Expected Duration of Processing  :-</label>
            <input type="number" class="form-control" id="duration_days" tabindex="8" name="duration_days">
            <input type="hidden" class="form-control" id="expected_receive_date" name="expected_receive_date">
          </div>
      </div>
      <input type="submit" name="save" class="btn btn-info w-25 font-weight-bold font-italic mb-5" tabindex="10" id="save" value="SAVE DATA">
  </form>
</div>
