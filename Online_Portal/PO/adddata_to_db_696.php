             ...
             if($run == true)
                {
                    ...
                    $query1 = "INSERT INTO po_entry_details(item_code,make_by,model_no,hsn_code,project,job,remark,stock,category,main_grade,sub_grade,qnty,unit,rate,basic_rate,iid,matUsedBy,mcno,superviser,department,plant,type,old_status,requisition_id,req_iid) VALUES ('".$value."','".$MakeBy[$key]."','".$ModelNo[$key]."','".$hsn_code[$key]."','".$project[$key]."','".$job[$key]."','".$remark[$key]."','".$stock[$key]."','".$c_code[$key]."','".$m_code[$key]."','".$s_code[$key]."','".$qnty[$key]."','".$unit[$key]."','".$rate[$key]."','".$basic_rate[$key]."','$podigit','".$use_by[$key]."','".$mcno[$key]."','".$person[$key]."','".$dpnt[$key]."','".$plant[$key]."','".$type[$key]."','".$old_part[$key]."','".$requisition_id[$key]."','".$req_id[$key]."')";
                  ...
                  if($run2 == true)
                  {
                      ...
                      if($run3 == true)
                    {
                      ...
                      $_SESSION['message'] = 'Po No:'.$podigit.' Created Successfully';
                          header("location:adddata-696.php");
                    }
                    else{
