...
<html lang="en">
    ...
    <body>
        ...
        var optionLink ='';
    optionLink = "<a class=\"btn btn-xs btn-danger\" href=\"deleteissue-696.php?sid=" + data.data.id + "\" onclick=\"return confirm('Are you sure you want to Delete?')\">Delete</a> " ;   
