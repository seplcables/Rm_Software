<?php
session_start();
if ($_SESSION['oid'] =='snehal' || $_SESSION['oid'] =='Rajnish' || $_SESSION['oid'] =='amey' || $_SESSION['oid'] =='rommel') 
{
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="row m-1">
      <div class="col-md-3">
          <select class="form-control" name="ope_date" id="ope_date" form="opening_form" onChange="GetClosing(this.value)">
                ...
                <?php
                include('..\..\..\dbcon.php');
                $sql="SELECT * FROM store_opening_date WHERE opening_date != (SELECT MAX(opening_date) FROM store_opening_date)";
