...
<html lang="en">
  ...
  <body>
    <div class="row bg-primary">
        <div class="col-md-5"><a href="../../dashboard.php" class="btn btn-warning"><<< Back</a></div>
        <div class="col-md-6" style="font-size: 24px;"><span align="center">STORE - LIVE STOCK - 696</span></div>
    </div>
    <br />
    <div class="table-responsive ml-1">
      <table class="table table-bordered table-striped table-sm" id="employee_data">
        ...
        //$query = "SELECT DISTINCT item FROM inward_store a join inward_ind b on a.po_no = b.p_po_no where b.receive_at IN ('D_696_plant','696_plant') and   a.receive_dte >='$dd'";
        ...
        // $querate="SELECT DISTINCT a.pur_rate, a.rec_qnty, a.order_qnty, b.qnty, b.unit, b.receive_dte from inward_ind a, inward_store b where   a.id = b.inward_ind_id and a.p_item = '$item' and b.item  = '$item' and b.receive_dte >='$dd' and a.p_unit = b.unit order by pur_rate DESC";
