   ...
   <head>
      ...
      li {
       ...
       <body>
            ...
            <form action="rm_issue_old_to_db.php" method="post">
<div class="card-body">
      <div class="container-fluid">
                  ...
                  <div class="row">
                        ...
                        <div class="col-sm-2">
                              <label> Date </label>
                              <input type="text" class="form-control" id="date" name="date" value="<?php echo date('d-M-y', time()); ?>">
                        </div>
                        ...
                        <table class="table" id="itemtable">
                              ...
                              <tbody>
                                    <tr>
                                          ...
                                          <td>
                                                <input type="text" class="form-control item" name="item[]" onFocus="SearchItem(this)">
                                          </td>
                                          ...
                                          <td><input type="text" class="form-control qty" name="qty[]" id="1qty"></td>
                                          <td>
                                                <select class="form-control unit" style="height:39px" name="unit[]">
     ...
     $("#date").click(function(){
      ...
      $(document).on('click', '#add_row', function () {
        ...
        rowHtml += '<td><input type="text" class="form-control item" name="item[]" onFocus="SearchItem(this)" value=""></td>';
