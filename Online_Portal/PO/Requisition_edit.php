				...
				<div class="card bg-faded mt-3">
					<div class="card-header bg-dark text-white">
						<div class="row justify-content-left mt-3">
							...
							<div class="col-lg-3 col-md-3 col-sm-12">
								<input type="submit" name="save" class="float-end bg-primary text-white btn" value="UPDATE">
							</div>
						</div>
					</div>
					<div class="card-body">
						...
						<div class="row justify-content-center">
							<div class="table-responsive">
								<table align="center" width="100%" id="receive" style="text-align: center;width: 100%;">
									<thead>
										<tr>
											<th>
											...
											<th>State</th>
											<th>Type</th>
											<th>Old_Part_Status  <button type="button" id="newbtn" name="newbtn" class="btn btn-sm btn-danger font-weight-bold text-white"style="height: 30px;width: 70px;margin-left: 10px;border-radius:5px;" >ADD</button> </th>
									...
									<tbody id="receive">								
										...
										<tr>
											...
											<td style="width:5%" name="sr" id="sr"><?php echo $count; ?></td>
											<td style="width:20%" ><input type="text" value="<?php echo $row1['item']; ?>" name="item_desc[]" onFocus="SearchItem(this)" class="form-control item" id="1Des" required><input type="hidden" value="<?php echo $row1['item_code']; ?>" name="i_code[]" class="i_code"><input type="hidden" name="new_row[]" value="<?php echo $row1['id']; ?>"></td>
											<td style="width:10%"><input type="number" step="0.01" value="<?php echo $row1['qnty']; ?>" name="Qnty[]" class="form-control" id="Qnt" required></td>
											<td style="width:10%"><input type="number" step="0.01" name="apx_cost[]" value="<?php echo $row1['rate']; ?>" class="form-control" id="apx_cost"></td>
											<td style="width:5%"><input type="text" name="mc[]" onFocus="SearchMc(this)" value="<?php echo $row1['mc']; ?>" class="form-control mcno" id="mc"></td>
											<td style="width:10%"><input type="text" name="dept[]" onFocus="SearchDpnt(this)" value="<?php echo $row1['department']; ?>" class="form-control dept" id="dept" required></td>
											<td style="width:8%"><input type="text" name="plant[]" class="form-control plant" value="<?php echo $row1['plant']; ?>" style="width:100%;" id="plant" readonly></td>
											<td style="width:10%">
												<input type="text" name="category[]" class="form-control category" value="<?php echo $row1['category']; ?>" style="width:100%;" id="category" readonly>
											</td>
											<td style="width:8%">
												<select class="form-select" aria-label="Default select example" id="state" name="state[]" style="width:100%;">
											...
											<td style="width:8%;">
												<select class="form-select type" aria-label="Default select example" id="type" name="status[]" style="width:100%;" required>
...
var rowHtml = '<tr>';
								...
								rowHtml += '<td style="width:2px" ><input type="text" name="item_desc[]" class="form-control item" onFocus="SearchItem(this)" style="width:340PX;" id="'+abc+'Des" required><input type="hidden" name="i_code[]" class="i_code"><input type="hidden" name="new_row[]" class="new_row"></td>';
							...
							rowHtml += '<td style="width:1px"><input type="number" step="0.01" name="apx_cost[]" class="form-control" style="width:100PX;" id="'+abc+'apx_cost"></td>';
								...
								rowHtml += '<td><input type="text" name="category[]" class="form-control category" style="width:100%" id="'+abc+'category" readonly></td>';
								rowHtml += '<td style="width:1px"><select class="form-select" aria-label="Default select example" id="'+abc+'state" name="state[]" style="width:100%"><option></option><option class="bg-dark text-white">Capital</option><option class="bg-dark text-white">Consumable</option><option class="bg-dark text-white">Raw Material</option></select></td>';
								rowHtml += '<td style="width:1px"><select class="form-select type" aria-label="Default select example" id="type" name="status[]" style="width:100%" required><option></option><option  class="bg-dark text-white">New</option><option  class="bg-dark text-white">Replace</option></select></td>';
								rowHtml += '<td style="width:1px"><select class="form-select hideit" aria-label="Default select example" id="'+abc+'old_part" name="old_part[]" style="width:100%"><option></option><option  class="bg-dark text-white">Repair</option><option  class="bg-dark text-white">Stock</option><option  class="bg-dark text-white">Scrap</option></select></td>';
rowHtml += '</tr>';
