<?php
		...
		
	{
        ...
        $query = "INSERT INTO po_entry_details(item_code,project,sub_project,job,remark,category,main_grade,sub_grade,qnty,unit,rate,basic_rate,matUsedBy,mcno,superviser,department,plant,type,old_status,iid,updated_by,createdAt) VALUES ('$i_code','$project','$sub_project','$job','$remark','$c_code','$m_code','$s_code','$qnty','$unit','$rate','$basic_rate','$useby','$mcno','$person','$dpnt','$plant','$type','$status','$poid','$user','$createdAt')";
