...
// Logo
		...
		$output='<table border="0.2" cellspacing="0">';
			$output .= '<tr bgcolor="#cccccc">';
				...
				$output .= '<th width="85" align="center">Make_by</th>';
				$output .= '<th width="85" align="center">Model_no</th>';
			...
			$output .= '<tr>';
				...
				$output .= '<td width="85" align="center">'.$row["make_by"].'</td>';
				$output .= '<td width="85" align="center">'.$row["model_no"].'</td>';
    ...
    $output .= '<td colspan="10" align="right"><b>TOTAL =>___ </b></td>';
