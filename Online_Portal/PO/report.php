...
<div class="row" style="margin: 5px;"> <br>
    ...
    <a href="report-old.php?getcat=&fromdate=&todate=" class="primary">Load All Data</a>
</div> <br/> 
<div id="grid" style="height: 670px; overflow: hidden;"></div>
<br>
...
let grid = new w2grid({
    ...
    columns: [
        ...
        { field: 'po_project', text: 'Po_project',size: '110px', size: '120px', sortable: true },
        { field: 'sub_project', text: 'Sub_project',size: '110px', size: '120px', sortable: true },
