...
// Logo
					      ...
					      include('..\..\dbcon.php');	
						  $sid = $_GET['sid'];
						  $sql1="SELECT a.iid,a.item_code,b.item,d.category,a.qnty,a.rate,a.qnty*a.rate as basic,a.mc,a.department,a.type,a.old_part_status,c.indentor,c.mat_require_dte,c.remarks,c.createdAt from Requisition_details a
       ...
       $output='<table border="0.1" cellspacing="0">';
			$output .= '<tr>';
				$output .= '<th bgcolor="#ebebe0" width="20" align="center">Sr No</th>';
				$output .= '<th bgcolor="#ebebe0" width="130" align="center">Item_Description</th>';
				$output .= '<th bgcolor="#ebebe0" width="90" align="center">Category</th>';
				$output .= '<th bgcolor="#ebebe0" width="50" align="center">Qnty</th>';
				$output .= '<th bgcolor="#ebebe0" width="50" align="center">Rate</th>';
				$output .= '<th bgcolor="#ebebe0" width="60" align="center">Basic_Val</th>';
				$output .= '<th bgcolor="#ebebe0" width="80" align="center">Dpnt(mc)</th>';
				$output .= '<th bgcolor="#ebebe0" width="75" align="center">Type</th>';
				$output .= '<th bgcolor="#ebebe0" width="60" align="center">oldPartStatus</th>';
