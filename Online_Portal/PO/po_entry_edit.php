...
<body>
  <div class="d-flex p-2 bg-secondary">
       ...
       <div class="col-9">
         <a href="showdata.php" class="btn btn-light btn-md float-end mx-1">BACK</a>
    ...
    <div>
      ...
      <form action="update_poentry.php" method="post" id="setform"> 
        <div class="row ml-4">
          ...
          <table class="table-bordered table-responsive m-1" style="width:99%">
            <thead>
              <tr>
                ...
                <th class="text-center">Sub_project</th>
    ...
    while ($row3 = sqlsrv_fetch_array($run3, SQLSRV_FETCH_ASSOC)) {
        ...
        $row4 = sqlsrv_fetch_array($run4, SQLSRV_FETCH_ASSOC); ?>
              <tr>
                <td><input type="text" name="item_desc[]" class="item_desc" value="<?php echo $row4['item']; ?>"><input type="hidden" name="i_code[]" class="i_code" value="<?php echo $row3['item_code']; ?>"><input type="hidden" name="s_code[]" class="s_code" value="<?php echo $row3['sub_grade']; ?>"><input type="hidden" name="m_code[]" class="m_code" value="<?php echo $row3['main_grade']; ?>"><input type="hidden" name="c_code[]" class="c_code" value="<?php echo $row3['category']; ?>"><input type="hidden" name="iid[]" value="<?php echo $row3['id']; ?>"></td>
        ...
        while ($row = sqlsrv_fetch_array($run, SQLSRV_FETCH_ASSOC)) {
            ?>
                ...
                <td><input type="text" name="project[]" id="projectn" value="<?php echo $row3['project']; ?>"></td>
                <td><input type="text" name="sub_project[]" value="<?php echo $row3['sub_project'];  ?>"></td>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body" id="add_modal">
                  <div id="add_item">
                    <form action="addItemToPo_to_db.php" method="POST" id="form">
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-8"><input type="text" name="project" class="form-control" id="projecti"></div>
                          </div>
                          <div class="row">
                            <div class="col-lg-4"><label>Sub Project</label></div>
                            <div class="col-lg-8"><input type="text" name="sub_project" class="form-control" id="sub_projecti"></div>
                          </div>
                          <div class="row">
