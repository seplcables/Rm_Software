...
if (!isset($_SESSION['pur_user'])) {
    ...
    header("location:..\dashboard.php");
     ...
     if (isset($_SESSION['plant'])) 
     {
        ...
        $sql="SELECT MAX(sr_no) as sr_value1 FROM inward_com where receive_at='696_plant'";
...
<body>
	...
	<div class="container-fluid">
		<form action="Purchase_db-696.php" id="form" method="post" enctype="multipart/form-data">
			<div class="row">
				<div class="col-lg-4">
					<table>
						<tr class="row mt-2"> 
