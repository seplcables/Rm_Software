...
<body>
    <div class="bg-primary" align="center" style="font-size:20px;">Purchase Report</div><br/>
    <a href="..\dashboard.php" class="btn btn-warning"><<< Back</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a href="report-old-696.php?getcat=&fromdate=&todate=" class="btn btn-info reset">Reset All</a>
    <div class="container-fluid">
        <form action="report-old-696.php" method="get" id="myForm">
            <div class="row">                
                <div class="col-md-3">
                    <label id="getitemtest"><h4>From Date</h4></label>
                    <input type="date" name="fromdate" id="fromdate" class="form-control" style="height:35px;">
                </div>
                <div class="col-md-3">
                    <label id="getitemtest"><h4>To Date</h4></label>
                    <input type="date" name="todate" id="todate" class="form-control" style="height:35px;">
                </div>
                <div class="col-md-3">
