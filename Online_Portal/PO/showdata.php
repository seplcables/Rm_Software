...
<html lang="en">
    ...
    <body>
        ...
        if (false) {  data.isPurchaseEntry > 0
          optionLink +=  "<button type=\"button\" id=\"not_edit\" onclick=\"notEditable()\" class=\"btn btn-sm\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Not Editable\">Edit</button>"; 
                ...
                optionLink +=  "<a class=\"btn btn-sm btn-primary\" href=\"po_entry_edit.php?id=" + data.id + "\">Edit</a> " ; 
          } 
          optionLink += "<a class=\"btn btn-sm btn-info\" href=\"pdfdata-landscape.php?sid=" + data.id + "\">New pdf</a> " ;
